...
## Table of Contents
- [Supabase Realtime Setup](#supabase-realtime-setup)
  - [Client Configuration](#client-configuration)
  - [Channel Subscription & Cleanup](#channel-subscription--cleanup)
- [Postgres Changes](#postgres-changes)
  - [Listen to INSERT/UPDATE/DELETE](#listen-to-insertupdatedelete)
  - [Typed Payload Helper](#typed-payload-helper)
  - [Enable Realtime on Table (SQL)](#enable-realtime-on-table-sql)
- [Broadcast](#broadcast)
  - [Typing Indicator](#typing-indicator)
  - [Cursor Sharing (Broadcast)](#cursor-sharing-broadcast)
- [Presence](#presence)
  - [Online Users List](#online-users-list)
  - [Presence UI Component](#presence-ui-component)
- [Chat Implementation](#chat-implementation)
  - [Full Chat Component](#full-chat-component)
  - [Chat Input with Typing Indicator](#chat-input-with-typing-indicator)
- [Live Dashboard](#live-dashboard)
  - [Realtime KPI Updates](#realtime-kpi-updates)
  - [Chart Data Streaming](#chart-data-streaming)
  - [Connection Status Indicator](#connection-status-indicator)
- [Multiplayer Cursors](#multiplayer-cursors)
  - [Full Implementation](#full-implementation)
  - [Cursor Renderer with Smooth Interpolation](#cursor-renderer-with-smooth-interpolation)
  - [Throttle Utility](#throttle-utility)
- [Connection Management](#connection-management)
  - [Reconnection Strategy with Exponential Backoff](#reconnection-strategy-with-exponential-backoff)
  - [Connection State UI](#connection-state-ui)
- [Performance](#performance)
  - [Channel Limits](#channel-limits)
  - [Unsubscribe Cleanup](#unsubscribe-cleanup)
  - [Server-Side Filtering](#server-side-filtering)
  - [Batching Updates](#batching-updates)
  - [RLS for Realtime Security](#rls-for-realtime-security)
