...
- [1. Next.js Cache Layers](#1-nextjs-cache-layers)
  - [Request Memoization (per-request, server only)](#request-memoization-per-request-server-only)
  - [Data Cache (persistent, server only)](#data-cache-persistent-server-only)
  - [Full Route Cache (persistent, server only)](#full-route-cache-persistent-server-only)
  - [Router Cache (client-side, in-memory)](#router-cache-client-side-in-memory)
  - [How layers interact](#how-layers-interact)
- [2. ISR / SSG / SSR / PPR Decision Tree](#2-isr-ssg-ssr-ppr-decision-tree)
  - [SSG — Static Site Generation](#ssg-static-site-generation)
  - [ISR — Incremental Static Regeneration](#isr-incremental-static-regeneration)
  - [PPR — Partial Prerendering (Next.js 15+)](#ppr-partial-prerendering-nextjs-15)
- [3. revalidatePath / revalidateTag](#3-revalidatepath-revalidatetag)
  - [On-demand revalidation with revalidatePath](#on-demand-revalidation-with-revalidatepath)
  - [Tag-based cache invalidation with revalidateTag](#tag-based-cache-invalidation-with-revalidatetag)
  - [Webhook-triggered revalidation](#webhook-triggered-revalidation)
- [4. TanStack Query Cache](#4-tanstack-query-cache)
  - [Basic configuration](#basic-configuration)
  - [Key timing concepts](#key-timing-concepts)
  - [placeholderData for instant UX](#placeholderdata-for-instant-ux)
  - [Prefetching in RSC (server-side hydration)](#prefetching-in-rsc-server-side-hydration)
  - [Cache invalidation](#cache-invalidation)
- [5. Redis / Upstash](#5-redis-upstash)
  - [Upstash Redis setup](#upstash-redis-setup)
  - [KV store for computed data](#kv-store-for-computed-data)
  - [Session cache](#session-cache)
  - [Rate limiting](#rate-limiting)
  - [TTL patterns](#ttl-patterns)
- [6. CDN Caching](#6-cdn-caching)
  - [Vercel Edge Cache with Cache-Control headers](#vercel-edge-cache-with-cache-control-headers)
  - [Cache-Control header breakdown](#cache-control-header-breakdown)
  - [Static assets on Vercel](#static-assets-on-vercel)
  - [Surrogate keys (tag-based CDN invalidation on Vercel)](#surrogate-keys-tag-based-cdn-invalidation-on-vercel)
- [7. SWR Pattern (Stale-While-Revalidate)](#7-swr-pattern-stale-while-revalidate)
  - [The concept](#the-concept)
  - [Implementation with fetch](#implementation-with-fetch)
  - [Implementation with TanStack Query](#implementation-with-tanstack-query)
  - [SWR with Upstash Redis](#swr-with-upstash-redis)
- [8. Cache Invalidation Strategies](#8-cache-invalidation-strategies)
  - [Event-driven invalidation](#event-driven-invalidation)
  - [Webhook-driven invalidation](#webhook-driven-invalidation)
  - [Time-based + event-based hybrid](#time-based-event-based-hybrid)
- [9. Browser Caching](#9-browser-caching)
  - [Service Worker cache (offline support)](#service-worker-cache-offline-support)
...
- [10. Anti-Patterns](#10-anti-patterns)
  ...
  - [Stale data bugs](#stale-data-bugs)
  - [Forgetting to invalidate](#forgetting-to-invalidate)
