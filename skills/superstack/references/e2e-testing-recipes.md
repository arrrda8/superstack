...
- [2. Auth Flows](#2-auth-flows)
  - [Storing auth state (reusable session)](#storing-auth-state-reusable-session)
  - [Config with setup project](#config-with-setup-project)
  - [Login test](#login-test)
  - [Signup test](#signup-test)
  - [Password reset](#password-reset)
- [3. CRUD Flows](#3-crud-flows)
  - [Verify database state via API](#verify-database-state-via-api)
- [4. Form Testing](#4-form-testing)
...
- [7. API Mocking](#7-api-mocking)
  - [Mock API responses](#mock-api-responses)
  - [Simulate errors](#simulate-errors)
  - [Intercept and modify](#intercept-and-modify)
  - [Wait for specific network request](#wait-for-specific-network-request)
- [8. Mobile Testing](#8-mobile-testing)
  - [Viewport sizes](#viewport-sizes)
  - [Touch events](#touch-events)
  - [Breakpoint testing helper](#breakpoint-testing-helper)
- [9. Accessibility Testing](#9-accessibility-testing)
  - [axe-core integration](#axe-core-integration)
  - [a11y test helper](#a11y-test-helper)
- [10. CI Integration](#10-ci-integration)
  - [GitHub Actions workflow](#github-actions-workflow)
  - [Parallel test execution with sharding](#parallel-test-execution-with-sharding)
  - [Merge shard reports](#merge-shard-reports)
- [11. Page Object Model](#11-page-object-model)
  - [Base page class](#base-page-class)
  - [Page implementation](#page-implementation)
  - [POM in tests](#pom-in-tests)
...
- [12. Performance Testing](#12-performance-testing)
  ...
  - [Performance measurement in Playwright](#performance-measurement-in-playwright)
