...
## Table of Contents
- [1. Receiving Webhooks](#1-receiving-webhooks)
  - [Next.js Route Handler](#nextjs-route-handler)
  - [Raw body parsing](#raw-body-parsing)
  - [Async processing pattern](#async-processing-pattern)
- [2. Signature Verification](#2-signature-verification)
  - [HMAC-SHA256 verification (generic)](#hmac-sha256-verification-generic)
  - [Stripe signature verification](#stripe-signature-verification)
  - [GitHub signature verification](#github-signature-verification)
- [3. Idempotency](#3-idempotency)
  - [Idempotency key storage](#idempotency-key-storage)
  - [Database upsert pattern](#database-upsert-pattern)
- [4. Retry Handling](#4-retry-handling)
  - [Responding with correct status codes](#responding-with-correct-status-codes)
  - [Timeout handling](#timeout-handling)
- [5. Dead Letter Queue](#5-dead-letter-queue)
  - [Failed webhook storage](#failed-webhook-storage)
  - [Manual retry API](#manual-retry-api)
- [6. Sending Webhooks](#6-sending-webhooks)
  - [Event system](#event-system)
  - [HTTP delivery with retry](#http-delivery-with-retry)
  - [Webhook registration API](#webhook-registration-api)
- [7. Security](#7-security)
  - [IP allowlisting](#ip-allowlisting)
  - [Replay attack prevention (timestamp validation)](#replay-attack-prevention-timestamp-validation)
  - [Secret rotation](#secret-rotation)
- [8. Testing](#8-testing)
  - [ngrok for local development](#ngrok-for-local-development)
  - [Stripe CLI for local testing](#stripe-cli-for-local-testing)
  - [Mock webhook payloads for tests](#mock-webhook-payloads-for-tests)
- [9. Common Integrations](#9-common-integrations)
  - [Stripe webhook handler (complete)](#stripe-webhook-handler-complete)
  - [GitHub webhook handler](#github-webhook-handler)
  - [Supabase Database Webhooks](#supabase-database-webhooks)
- [10. Monitoring](#10-monitoring)
  - [Webhook delivery dashboard data](#webhook-delivery-dashboard-data)
  - [Structured logging for webhook events](#structured-logging-for-webhook-events)
