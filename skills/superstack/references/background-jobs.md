...
- [2. Inngest](#2-inngest)
  ...
  - [Serve endpoint (Next.js App Router)](#serve-endpoint-nextjs-app-router)
  - [Event-driven function](#event-driven-function)
  - [Sending events](#sending-events)
  - [Cron schedule](#cron-schedule)
  - [Fan-out pattern](#fan-out-pattern)
  - [Step function patterns](#step-function-patterns)
- [3. Trigger.dev](#3-triggerdev)
  - [Installation & Setup](#installation-setup)
  - [Task definition (v3)](#task-definition-v3)
  - [Triggering tasks](#triggering-tasks)
  - [Scheduled tasks (cron)](#scheduled-tasks-cron)
- [4. Vercel Cron](#4-vercel-cron)
  - [Configuration](#configuration)
  - [Route handler as cron endpoint](#route-handler-as-cron-endpoint)
  - [Limitations](#limitations)
- [5. Common Patterns](#5-common-patterns)
  - [Email sending queue](#email-sending-queue)
  - [Image processing](#image-processing)
  - [Report generation](#report-generation)
  - [Data sync](#data-sync)
  - [Cleanup jobs](#cleanup-jobs)
- [6. Retry Strategies](#6-retry-strategies)
  - [Exponential backoff (Inngest)](#exponential-backoff-inngest)
  - [Custom retry (Trigger.dev)](#custom-retry-triggerdev)
  - [Non-retryable errors](#non-retryable-errors)
  - [Dead letter / failure handling](#dead-letter-failure-handling)
  - [Idempotent jobs](#idempotent-jobs)
- [7. Job Monitoring](#7-job-monitoring)
  - [Inngest dashboard](#inngest-dashboard)
  - [Failed job alerts](#failed-job-alerts)
  - [Custom monitoring with Supabase](#custom-monitoring-with-supabase)
- [8. Rate Limiting](#8-rate-limiting)
  - [Job concurrency limits (Inngest)](#job-concurrency-limits-inngest)
  - [Rate limiting with Inngest](#rate-limiting-with-inngest)
  - [Throttling pattern](#throttling-pattern)
- [9. Long-Running Tasks](#9-long-running-tasks)
  - [Progress tracking](#progress-tracking)
  - [Cancellation](#cancellation)
  - [Timeout handling](#timeout-handling)
- [10. Testing](#10-testing)
  - [Testing job handlers in isolation](#testing-job-handlers-in-isolation)
  - [Separation pattern for testability](#separation-pattern-for-testability)
  - [Mocking Inngest step functions](#mocking-inngest-step-functions)
  - [Integration tests with Inngest Dev Server](#integration-tests-with-inngest-dev-server)
