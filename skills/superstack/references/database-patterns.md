...
## Table of Contents
- [1. ORM Comparison — Prisma vs Drizzle vs Raw SQL](#1-orm-comparison--prisma-vs-drizzle-vs-raw-sql)
  - [Decision Matrix](#decision-matrix)
  - [Recommendation](#recommendation)
  - [Drizzle Setup (with Supabase)](#drizzle-setup-with-supabase)
  - [Supabase Client (Recommended for Supabase Projects)](#supabase-client-recommended-for-supabase-projects)
- [2. Schema Design](#2-schema-design)
  - [Naming Conventions](#naming-conventions)
  - [UUIDs vs CUID2](#uuids-vs-cuid2)
  - [JSON Columns](#json-columns)
  - [Enums](#enums)
- [3. Seeding](#3-seeding)
  - [Seed Script with Faker.js](#seed-script-with-fakerjs)
  - [Environment-Aware Seeding](#environment-aware-seeding)
- [4. Connection Pooling](#4-connection-pooling)
  - [Supabase Connection Strings](#supabase-connection-strings)
  - [Serverless Considerations](#serverless-considerations)
  - [Connection Limits](#connection-limits)
- [5. Row Level Security (RLS)](#5-row-level-security-rls)
  - [Enable RLS on Every Table](#enable-rls-on-every-table)
  - [Pattern: Own Data](#pattern-own-data)
  - [Pattern: Team/Organization Data](#pattern-teamorganization-data)
  - [Pattern: Admin Bypass](#pattern-admin-bypass)
  - [Service Role Bypass](#service-role-bypass)
  - [Testing RLS](#testing-rls)
- [6. Soft Delete](#6-soft-delete)
  - [Implementation](#implementation)
  - [Soft Delete Function](#soft-delete-function)
  - [Querying with Soft Delete (Supabase)](#querying-with-soft-delete-supabase)
  - [RLS-Based Automatic Filtering](#rls-based-automatic-filtering)
  - [Cascading Soft Delete](#cascading-soft-delete)
- [7. Pagination](#7-pagination)
  - [Offset Pagination (Simple, Suitable for Small Datasets)](#offset-pagination-simple-suitable-for-small-datasets)
  - [Cursor/Keyset Pagination (Production-Grade)](#cursorkeyset-pagination-production-grade)
  - [Infinite Scroll with React Query](#infinite-scroll-with-react-query)
- [8. Full-Text Search](#8-full-text-search)
  - [Setup tsvector Column and GIN Index](#setup-tsvector-column-and-gin-index)
  - [Search with Ranking](#search-with-ranking)
  - [Supabase textSearch()](#supabase-textsearch)
  - [Search with Highlights](#search-with-highlights)
- [9. Migrations](#9-migrations)
  - [Supabase Migration Workflow](#supabase-migration-workflow)
  - [Manual Migration File](#manual-migration-file)
  - [Rollback Strategy](#rollback-strategy)
  - [Zero-Downtime Migration Patterns](#zero-downtime-migration-patterns)
- [10. Database Functions & Triggers](#10-database-functions--triggers)
  - [Auto-Update updated_at](#auto-update-updated_at)
  - [Computed Columns (Generated)](#computed-columns-generated)
